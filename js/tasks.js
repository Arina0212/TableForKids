...
function check() {
  if (testElement.classList.contains('task1') == true) {
    ...
    if(document.getElementById("answer2").value == 9){
      document.getElementById("answer2").style.border = '6px dashed #58A532'
    }
    if ((document.getElementById("answer1").value == 3) && (document.getElementById("answer2").value == 9)) {
    ...
    if ((document.getElementById("answer1").value == 6) && (document.getElementById("answer2").value == 12)) {
      button.style.opacity = '0'
      next.classList.add("active");
    ...
    if ((document.getElementById("answer1").value == 27) && (document.getElementById("answer2").value == 15)) {
      button.style.opacity = '0'
      next.classList.add("active");
    ...
    if ((document.getElementById("answer1").value == 8) && (document.getElementById("answer2").value == 12)) {
      button.style.opacity = '0'
    ...
    if (document.getElementById("answer1").value == 28){
      document.getElementById("answer1").style.border = '6px dashed #58A532'
    }
    if(document.getElementById("answer2").value == 4){
      document.getElementById("answer2").style.border = '6px dashed #58A532'
    }
    if ((document.getElementById("answer1").value == 28) && (document.getElementById("answer2").value == 4)) {
      button.style.opacity = '0'
      next.classList.add("active");
    ...
    if(document.getElementById("answer2").value == 30){
      document.getElementById("answer2").style.border = '6px dashed #58A532'
    }
    if ((document.getElementById("answer1").value == 25) && (document.getElementById("answer2").value == 30)) {
      button.style.opacity = '0'
      next.classList.add("active");
  ...
  }else if (testElement.classList.contains('task1_3') == true) {
